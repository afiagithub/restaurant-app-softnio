...
const Navbar = () => {
    ...
    return (
        ...
        style={{backgroundImage: `url(${bgImg}), linear-gradient(123.4deg, #BD1F17 40.8%, #A61D13 76.4%, #8E1B0F 120.69%)`}}>
            <div className="navbar-start">
                <div className="dropdown absolute right-5">
                    <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
                    </div>
                    <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-50 p-2 shadow bg-base-100 
            ...
            <div className="navbar-end hidden lg:flex">
                <CommonBtn btnText={'Book a Table'}/>
            </div>
        </div >
