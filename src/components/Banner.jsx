        ...
        <div className="hero min-h-[50vh] px-7 lg:px-44 py-8 text-white font-robo"
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center gap-5 lg:gap-0">
                <div className='lg:-mr-16 z-10 px-5 lg:px-0'>
                    ...
                    <Link className="btn bg-[#FEBF00] text-black font-bold lg:text-lg border-2 border-[#FEBF00] 
                hover:border-[#FEBF00] hover:hover:text-[#FEBF00] hover:bg-transparent" to="/">Explore Menu</Link>
                </div>
                <div className='relative'>
                    ...
                    <div className='absolute -right-10 -bottom-10 w-20 h-20 capitalize font-bebas text-xl 
                    bg-[#FEBF00] rounded-full flex flex-row justify-center items-center text-black'>
